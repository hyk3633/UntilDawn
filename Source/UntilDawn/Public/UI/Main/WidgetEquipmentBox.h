...
DECLARE_DELEGATE_OneParam(DelegateOnEquipmentRemoved, EEquipmentBox boxType);
...
public:
	...
	void SetEquipmentAndBoxType(const EItemMainType newItemType, const EEquipmentBox newBoxType);
